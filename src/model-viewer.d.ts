...
import {
  ...
  Wrapping,
  Object3D,
  Material as Material$4,
  Texture as Texture$4,
  Vector3 as Vector3$1,
  Mesh as Mesh$1,
  WebGLRenderer,
  Scene as Scene$1,
  PerspectiveCamera as PerspectiveCamera$1,
  Camera as Camera$2,
  Event,
  Box3,
  Sphere,
...
declare type ChannelTargetPath =
  | "rotation"
  | "scale"
  | "translation"
  | "weights";
...
declare class ModelScene extends Scene$1 {
  ...
  hitFromPoint(
    ndcPosition: Vector2$1,
    object?: Object3D
  ): three.Intersection<Object3D<Event>> | undefined;
  /**
...
declare class CachingGLTFLoader<
...
declare class TextureUtils extends EventDispatcher {
   ...
   */
  generateEnvironmentMapAndSkybox(
...
declare class ModelViewerElementBase extends ReactiveElement {
   ...
   */
  [$updateSize]({ width, height }: { width: number; height: number }): void;
...
declare type CorrelatedObjects =
  | Set<Object3D>
  | Set<Material$4>
  | Set<Texture$4>;
/**
...
declare class Image extends ThreeDOMElement implements Image$1 {
  get [$threeTexture$1](): Texture$4;
  constructor(
    onUpdate: () => void,
    texture: Texture$4 | null,
    gltfImage: Image$3 | null
  );
  get name(): string;
...
declare class Texture extends ThreeDOMElement implements Texture$1 {
  ...
  constructor(
    onUpdate: () => void,
    threeTexture: Texture$4 | null,
    gltfTexture?: Texture$3 | null,
    gltfSampler?: Sampler$3 | null,
    gltfImage?: Image$3 | null
  );
  get name(): string;
...
declare class TextureInfo implements TextureInfo$1 {
  ...
  constructor(
    ...
    usage: TextureUsage,
    threeTexture: Texture$4 | null,
    material: Set<MeshStandardMaterial>,
    gltf: GLTF$1,
    gltfTextureInfo: TextureInfo$3 | null
  );
 ...
 */
declare class PBRMetallicRoughness
  extends ThreeDOMElement
  implements PBRMetallicRoughness$1
{
...
declare class Material extends ThreeDOMElement implements Material$1 {
  ...
  constructor(
    onUpdate: () => void,
    gltf: GLTF$1,
    gltfMaterial: Material$3,
    gltfIndex: number,
    isActive: boolean,
    modelVariants: Map<string, VariantData>,
    correlatedMaterials: Set<MeshStandardMaterial>,
    lazyLoadInfo?: LazyLoader | undefined
  );
  private [$initialize];
