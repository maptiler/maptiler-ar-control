(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@maptiler/sdk')) :
  typeof define === 'function' && define.amd ? define(['exports', '@maptiler/sdk'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["maptiler-ar-control"] = {}, global.maptilersdk));
  ...
  */
  ...
  class MaptilerARControl extends EventEmitter {
    ...
    compute() {
      return __async(this, null, function* () {
        ...
        const middleWest = new sdk.LngLat(this.mapCaptureBounds.getWest(), center.lat);
        const middleEast = new sdk.LngLat(this.mapCaptureBounds.getEast(), center.lat);
    ...
    init3DScene(container) {
      ...
      this.threeTileContainer = new Object3D();
    ...
    createMapMesh() {
      ...
      const mapGeom = new PlaneGeometry(
        widthMeter,
        heightMeter,
        this.terrainData.width - 1,
        this.terrainData.height - 1
      );
      const mapMesh = new Mesh(mapGeom, material);
      ...
      const bottomPlaneGeom = new PlaneGeometry(
        widthMeter,
        heightMeter,
        1,
        1
      );
      const bottomPlaneMat = new MeshBasicMaterial({
        side: BackSide,
        color: 2037010
      });
  ...
  exports.MaptilerARControl = MaptilerARControl;
  exports.mapTextureDataToCanvas = mapTextureDataToCanvas;

  Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=maptiler-ar-control.js.map
